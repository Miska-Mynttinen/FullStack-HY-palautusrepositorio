...
describe('favorite blog', () => {
  ...
  test('when list has only one blog returns the author of that blog and the amount of likes', () => {
  ...
  test('of a bigger list returns the author with most likes and the amount of likes', () => {
